...
from apps.authentication.views import UserListCreateView, UserDetailView
...
urlpatterns = [
    ...
    # Top-level Users CRUD — matches what the React admin panel (src/lib/api.ts) calls directly.
    path('api/v1/users/', UserListCreateView.as_view(), name='top_level_user_list_create'),
    path('api/v1/users/<int:pk>/', UserDetailView.as_view(), name='top_level_user_detail'),
